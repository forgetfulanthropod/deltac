    ...
    <ScrollView contentInset={{ bottom: BottomTabInset }} contentContainerStyle={styles.scrollBody}>
      <SafeAreaView style={styles.safeArea}>
        ...
        <ThemedView type="backgroundElement" style={styles.block}>
          <ThemedText type="subtitle">Progress playback</ThemedText>
          <ThemedText themeColor="textSecondary">
            The burndown animates task completion order (stub playback).
          </ThemedText>
        ...
        <ThemedView style={styles.section}>
          <ThemedText type="subtitle">Remaining stories & tasks</ThemedText>
        ...
        <ThemedView style={styles.section}>
          ...
          <Collapsible title="Scoping — generate remodels → select">
            <ThemedText type="small" themeColor="textSecondary">
              Generate remodel options for the space, compare them, then select one to become the
              active project plan (Stories → Tasks → points).
            </ThemedText>
          </Collapsible>

          <Collapsible title="Sourcing — auto-source → accept all">
            <ThemedText type="small" themeColor="textSecondary">
              Materials are recommended per task and auto-sourced from connected distributors.
              “Accept all” places consolidated orders (Amazon / Home Depot / etc.).
            </ThemedText>
          </Collapsible>

          <Collapsible title="Scheduling — lean planning → automatic diagrams → editable">
            <ThemedText type="small" themeColor="textSecondary">
              Stories, tasks, points, and dependencies drive burndown and critical path outputs.
              Owners can edit dates, assignments, and dependencies.
            </ThemedText>
          </Collapsible>
        </ThemedView>
      </SafeAreaView>
